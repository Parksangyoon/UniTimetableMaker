...
class SubjectInfo(models.Model):
    ...
    class Type(DjangoChoices):
        ...
        def from_string(cls, string_of_type):
            if string_of_type == '전공':
                return SubjectInfo.Type.MAJOR
            elif string_of_type == '전선':
                return SubjectInfo.Type.SELECT
    ...
    def set_model(self, data):
        set_data = SubjectInfo(
            ...
            subject_name=data.get(NAME), credit=data.get(CREDIT), duration=data.get(DURATION),
    ...
    subject_name = models.CharField(max_length=100)             # 교과목명
